...
function Posts(props) {
    ...
    return <>
        ...
        <Drawer onClose={drawerClose.wechat} open={Visible.wechat} title="这是我的微信，来和我击剑呀 🤺" elevation={900} anchor='right' >
        ...
        <Drawer onClose={drawerClose.tg} open={Visible.tg} title="这是我的tg，来和我击剑呀 🤺" elevation={900} anchor='right'>
        <div className='post-drawer-center'>
                <div>
