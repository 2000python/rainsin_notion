        ...
        <div className='blog-posts'>
            <div className='left-posts-chunk'>
                <BarChunk isTag={false} content='ABOUT ME' fontsize={40}>
                    <ShowChunk outwidth='100%'>
                        <TextboxChunk fontsize={18}>
                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;🐟 🌅 ✌ ，🇨🇳 一个不止于code的程序猿 👨‍💻 ，🛸 喜欢一些奇奇怪怪的东西 👽 ，🎼 一个老Jay迷 🎧，也是一个喜欢听秦腔的老秦人 👺。
                        </TextboxChunk>
                        <TextboxChunk fontsize={18}>
                            <TextChunk Class='bar-textbox-font-color bar-post-aboutme-contact-local'  width='100%' fontSize={14} onClick={drawerShow.wechat}>
                            ...
                            <TextChunk Class='bar-textbox-font-color bar-post-aboutme-contact-local'  width='100%' fontSize={14}>
                            ...
                            <TextChunk Class='bar-textbox-font-color bar-post-aboutme-contact-local' width='100%' url='https://github.com/2000python' fontSize={14}>
                            ...
                            <TextChunk Class='bar-textbox-font-color bar-post-aboutme-contact-local'  width='100%' fontSize={14} onClick={drawerShow.tg} >
            ...
            <ul className='right-posts-chunk'>
                {data.map((item, index) => {
                    ...
                    return index <= length ? <li key={index}>
                        <ShowChunk title={`${item.title}`} Class='showchunk-grid'>
                            <TextChunk Class='show-chunk-title' content={`${item.title}`} fontSize={16} width='100%' alpha={.2} />
                        </ShowChunk>
                    </li> : ''
                })}
            </ul>
