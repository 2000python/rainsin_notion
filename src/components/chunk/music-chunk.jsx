...
function MusicListItem(props) {
  ...
  return <>
    <Link to='/' className='music-list-thead-detial' onClick={paly_item}>
            <li>
              <TextButtonChunk alpha={.9}>
...
export const MusicControl = observer({
  ...
  PlayState: observer((props) => {
    ...
    return <>
      <div className={"music-transition " + context.music_control_class.play_box_state}>
        <TextButtonChunk title='上一曲' isPreventDefault={true} fontSize={42} svgwidth={40}>
        <svg t="1648028061648" className="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="1769" width="200" height="200"><path d="M699.8 788.7c-55.5 37.6-120.4 57.4-187.7 57.4-184.8 0-335.2-150.4-335.2-335.2 0-66.4 19.4-130.6 56-185.6 7.5-11.2 4.4-26.4-6.8-33.9s-26.4-4.4-33.9 6.8c-42 63.1-64.2 136.6-64.2 212.7 0 211.8 172.3 384 384.1 384 77.1 0 151.5-22.8 215.1-65.9 11.2-7.6 14.1-22.8 6.5-33.9-7.6-11.1-22.8-14-33.9-6.4zM512.1 126.9c-82 0-160.3 25.5-226.3 73.7-10.9 8-13.3 23.2-5.3 34.1 8 10.9 23.2 13.3 34.1 5.3 57.6-42.1 125.9-64.3 197.5-64.3 184.8 0 335.2 150.4 335.2 335.2 0 71.6-22.2 139.8-64.3 197.4-8 10.9-5.6 26.2 5.3 34.1 4.3 3.2 9.4 4.7 14.4 4.7 7.5 0 15-3.5 19.7-10 48.2-66 73.7-144.3 73.7-226.2 0-211.7-172.3-384-384-384z" fill="#e6e6e6" p-id="1770"></path><path d="M429.1 617.9v-81.7L607.2 639c3.8 2.2 8 3.3 12.2 3.3s8.4-1.1 12.2-3.3c7.5-4.4 12.2-12.5 12.2-21.2V398.1c0-8.8-4.6-16.8-12.2-21.2-7.5-4.4-16.8-4.4-24.4 0L429.1 479.8v-81.7c0-13.5-10.9-24.4-24.4-24.4s-24.4 10.9-24.4 24.4v219.7c0 13.5 10.9 24.4 24.4 24.4s24.4-10.9 24.4-24.3zM478 508l117-67.6v135.1L478 508z" fill="#e6e6e6" p-id="1771"></path></svg>
        </TextButtonChunk>
        <TextButtonChunk title="播放/暂停" onClick={onPlay} isPreventDefault={true} fontSize={42} svgwidth={40}>
          {context.music_paly ? <svg t="1648028033718" className="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="1548" width="200" height="200"><path d="M700 789.1c-55.4 37.6-120.3 57.4-187.6 57.4-184.7 0-334.9-150.2-334.9-334.9 0-66.3 19.4-130.5 56-185.4 7.5-11.2 4.4-26.4-6.8-33.8-11.2-7.4-26.4-4.4-33.8 6.8-42 63-64.2 136.5-64.2 212.5 0 211.6 172.2 383.7 383.7 383.7 77.1 0 151.4-22.8 214.9-65.8 11.2-7.6 14.1-22.7 6.5-33.9-7.5-11.3-22.7-14.1-33.8-6.6zM512.4 127.8c-81.9 0-160.1 25.5-226.1 73.6-10.9 8-13.3 23.2-5.3 34.1 7.9 10.9 23.2 13.3 34.1 5.3 57.6-42 125.8-64.2 197.3-64.2 184.7 0 334.9 150.2 334.9 334.9 0 71.5-22.2 139.7-64.2 197.3-8 10.9-5.6 26.2 5.3 34.1 4.3 3.2 9.4 4.7 14.4 4.7 7.5 0 15-3.5 19.7-10 48.2-66 73.6-144.1 73.6-226.1 0.1-211.5-172.1-383.7-383.7-383.7z" fill="#e6e6e6" p-id="1549"></path><path d="M471.2 618.4V404.8c0-18-14.6-32.5-32.5-32.5s-32.5 14.6-32.5 32.5v213.6c0 18 14.6 32.5 32.5 32.5s32.5-14.6 32.5-32.5zM618.8 618.4V404.8c0-18-14.6-32.5-32.5-32.5-18 0-32.5 14.6-32.5 32.5v213.6c0 18 14.6 32.5 32.5 32.5s32.5-14.6 32.5-32.5z" fill="#e6e6e6" p-id="1550"></path></svg> :
        ...
        <TextButtonChunk title="下一曲" isPreventDefault={true} fontSize={42} svgwidth={40}>
        <svg t="1648028078240" className="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="1990" width="200" height="200"><path d="M699.8 788.7c-55.5 37.6-120.4 57.4-187.7 57.4-184.8 0-335.2-150.4-335.2-335.2 0-66.4 19.4-130.6 56-185.6 7.5-11.2 4.4-26.4-6.8-33.9s-26.4-4.4-33.9 6.8c-42 63.1-64.2 136.6-64.2 212.7 0 211.8 172.3 384 384.1 384 77.1 0 151.5-22.8 215.1-65.9 11.2-7.6 14.1-22.8 6.5-33.9-7.6-11.1-22.8-14-33.9-6.4zM512.1 126.9c-82 0-160.3 25.5-226.3 73.7-10.9 8-13.3 23.2-5.3 34.1 8 10.9 23.2 13.3 34.1 5.3 57.6-42.1 125.9-64.3 197.5-64.3 184.8 0 335.2 150.4 335.2 335.2 0 71.6-22.2 139.8-64.3 197.4-8 10.9-5.6 26.2 5.3 34.1 4.3 3.2 9.4 4.7 14.4 4.7 7.5 0 15-3.5 19.7-10 48.2-66 73.7-144.3 73.7-226.2 0-211.7-172.3-384-384-384z" fill="#e6e6e6" p-id="1991"></path><path d="M619.4 642.2c13.5 0 24.4-10.9 24.4-24.4V398.1c0-13.5-10.9-24.4-24.4-24.4-13.5 0-24.4 10.9-24.4 24.4v81.7L416.9 376.9c-7.6-4.4-16.9-4.4-24.4 0-7.6 4.4-12.2 12.4-12.2 21.2v219.7c0 8.7 4.7 16.8 12.2 21.2 3.8 2.2 8 3.3 12.2 3.3 4.2 0 8.4-1.1 12.2-3.3L595 536.2v81.7c0 13.4 10.9 24.3 24.4 24.3z m-190.3-66.7V440.4l117 67.6-117 67.5z" fill="#e6e6e6" p-id="1992"></path></svg>
        </TextButtonChunk>
      </div>
    </>
  }),
  ...
  VolumeState: observer((props) => {
    ...
    const show_music_volume = () => {
      setShow((preV,newV) => newV = !preV);
    }
    return <>
      <div>
        
        <TextButtonChunk title="音量" isPreventDefault={true} onClick={is_change_volume} MouseOver={show_music_volume} MouseOut={show_music_volume} fontSize={40} lineheight=' _'  svgwidth={38}>
          <VolumeBox></VolumeBox>
          {show ? <>
